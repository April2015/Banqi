...
module gameLogic {
     ...
     * @returns {*[]}
     */
    export function initialGame() : IMove {
     ...
     * @returns {string}
     */
    function getWinner(stateBeforeMove : IState, turnIndexAfterMove : number): string {
        var numR = 0;
        var numB = 0;
        for (var i = 0; i < 4; i++) {
            for (var j = 0; j < 8; j++) {
     ...
     * @returns {boolean}
     */
    function isTie(stateBeforeMove: IState): boolean {
        var numR = 0;
        var numB = 0;
        var Rx = 0;
        var Ry = 0;
     ...
     * @returns {boolean}
     */
    function isNext(x1: number, y1: number, x2: number, y2: number) : boolean {
     ...
     * @returns {Array}
     */
export  function getPossibleMoves(stateBeforeMove: IState, turnIndexBeforeMove: number): IMove[] {
     ...
     * @returns {*}
     */
  export function createMove(stateBeforeMove: IState, rowBeforeMove: number,
      colBeforeMove: number, rowAfterMove: number, colAfterMove: number, turnIndexBeforeMove: number): IMove {
     ...
     */
    export function checkGameEnd(stateBeforeMove: IState, turnIndexBeforeMove: number): IMove {
        var firstOperation: IOperation;
        var winner: string = getWinner(stateBeforeMove, 1 - turnIndexBeforeMove);
     ...
     * @returns {*[]}
     */
    function movePiece(stateBeforeMove: IState, rowBeforeMove: number, colBeforeMove: number,
      rowAfterMove: number, colAfterMove: number): IMove {
     ...
     * @returns {*[]}
     */
    function killPiece(stateBeforeMove: IState, rowBeforeMove: number,
      colBeforeMove: number, rowAfterMove: number, colAfterMove: number): IMove {
